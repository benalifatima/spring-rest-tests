 ...
 *
 */
public class AccountTestDb extends AbstractTest {

	@Test
	public void getAccounts() throws Exception {
		mockMvc.perform(get("/accountsDb")).andExpect(status().isOk())
	...
	public void getAccountDetails() throws Exception {
		mockMvc.perform(get("/accountsDb/1")).andExpect(status().isOk())
	...
	public void getAccountDetailsOnUnexistingAccount() throws Exception {
		mockMvc.perform(get("/accountsDb/test")).andExpect(status().isNotFound())
